...
- Match existing Bash formatting; when using shfmt, use `-bn -ci -i=2`.
...
The repository does not currently pin shell format/lint hooks; these are contributor conventions.
